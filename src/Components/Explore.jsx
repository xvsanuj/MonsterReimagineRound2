...
const Explore = () => {
  return (
    <div className='min-h-screen w-full'>
      ...
      <div className="h-[40vh] w-full relative flex flex-col lg:flex-row">
        <div className="h-full w-full relative">
          <img className="h-full w-full object-cover object-top" src="https://raw.githubusercontent.com/xvsanuj/XiaomiReimagined/main/src/assets/Images/Explore/2.jpeg" alt="Xiaomi 1" />
        </div>
        <div className="h-full w-full relative">
          <img className="h-full w-full object-cover object-top" src="https://raw.githubusercontent.com/xvsanuj/XiaomiReimagined/main/src/assets/Images/Explore/3.jpeg" alt="Xiaomi 2" />
        </div>
      </div>
    </div>
  )
