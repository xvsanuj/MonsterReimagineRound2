  ...
  return (
    <div className='h-screen w-full'>
      <div className='h-[60vh] relative w-full'>
        <img className='h-[60vh] w-full object-cover object-top' src="./src/assets/Images/Explore/1.jpeg" alt="" />
      ...
      <div className="h-[40vh] w-full relative flex">
        <div className="h-full w-full relative">
          <img className="h-full w-full object-cover object-top" src="./src/assets/Images/Explore/2.jpeg" alt="" />
        </div>
        <div className="h-full w-full relative">
          <img className="h-full w-full object-cover object-top" src="./src/assets/Images/Explore/3.jpeg" alt="" />
        </div>
      </div>
    </div>
  )
